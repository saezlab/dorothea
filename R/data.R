#' Non-academic version of human DoRothEA
#'
...
#'   TF/interaction. The range is from A (high quality) to E (low quality). This
#'   resource is a subset of the academic version free for commerical use.
#'
#'
...
#' Non-academic version of mouse DoRothEA
#'
#' A table reporting signed human TF-target interactions. This database covers
...
#' Non-academic version of Entire database with associated meta data
#'
...
#'   required information to trace back the origin of the interaction. This
#'   resource is a subset of the academic version free for commerical use.
#'
#'
#' @keywords datasets
